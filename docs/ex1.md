...
2. コース内の **「認定証提出（paiza「Python 体験編 1: Python をはじめよう」）」** の課題を開き、撮影したスクリーンショット画像を提出してください。
...
演習課題 1 でログインした **aiJudge** で、ex1 の次の 3 問すべてで**満点を取って**ください。

1. `hello.py` — 文字列を 1 行出力する
2. `input.py` — 1 行読んでそのまま出力する
3. `nhello.py` — 整数 n を読んで n 回出力する
